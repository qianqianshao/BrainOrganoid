...
#	dir=paste0("/scratch/junzli_root/junzli/qzm/Data/",run[i],"/10x_analysis_",run[i],"/Sample_",dataset[[i]][1],"/filtered_feature_bc_matrix/")
  dir=paste0("/nfs/turbo/umms-junzli/qzm/Data/",run[i],"/10x_analysis_",run[i],"/Sample_",dataset[[i]][1],"/outs/filtered_feature_bc_matrix/")
...
colnames(data1)=paste0(paste(gexset[i],colnames(data1),sep="_"),"-1")
htolist[[i]]=data1
print(data1[,1:2])
#      2931-AT-1_GCCTGTTTCAACCCGG 2931-AT-1_TCACTCGAGAGTGTGC
#HTO-1                          0                          2
#HTO-2                          1                          2
#HTO-3                          2                          3
#      2931-AT-2_GGCAGTCTCCCGAATA 2931-AT-2_TCCTCCCCAAGACAAT
#HTO-4                         22                         28
#HTO-5                         37                         26
#HTO-6                         47                          7
...
Cutoff for HTO-1 : 31 reads
Cutoff for HTO-2 : 16 reads
Cutoff for HTO-3 : 148 reads

Cutoff for HTO-4 : 25 reads
Cutoff for HTO-5 : 15 reads
Cutoff for HTO-6 : 133 reads
